# Linux_Configuration
#Prepared by PAVANKUMAR KOTHAGUNDU
...
- The web application is my [Catalog project](https://github.com/PavankumarKothagundu) created earlier in this Nanodegree program.
- The database server is [PostgreSQL](https://www.postgresql.org/).

You can visit http://35.170.249.132.xip.io/ or http://ec2-35-170-249-132.compute-1.amazonaws.com for the website deployed.
...
### Step 1: Start a new Ubuntu Linux server instance on Amazon EC2 
  ...
  - Check for instance IPv4 public IP - 35.170.249.132
  - we can download a .pem file and connect with following command
    ```
    ssh -i linux_28.pem ubuntu@35.170.249.132
    ``` 
...
- To check port 2200 wether working or not by `ssh -i pavankumar2000.pem -p 2200 ubuntu@35.170.249.132` 
...
### Step 7: Create an SSH key pair for `grader`
  ...
  - Restart SSH: `sudo service ssh restart`
  - On the local machine, cheking if the grader account working or not by running this command : `ssh -i pavankumar2000.pem -p 2200 grader@35.170.249.132`.
...
`sudo git clone https://github.com/PavankumarKothagundu/catalog.git`.
...
- Click `Credentials`.
- Create an OAuth Client ID (under the Credentials tab), and add http://35.170.249.132.xip.io and 
http://ec2-35-170-249-132.compute-1.amazonaws.com as authorized JavaScript 
origins.
- Add http://35.170.249.132.xip.io/login ,
http://35.170.249.132.xip.io/gconnect , http://35.170.249.132.xip.io/callback/
...
### Step 13.2: Set up and enable a virtual host
  ...
  ```
  <VirtualHost *:80>
      ServerName 35.170.249.132.xip.io
      ServerAlias ec2-35-170-249-132.compute-1.amazonaws.com
      ServerAdmin ubuntu@35.170.249.132
...
- Open your browser to http://35.170.249.132.xip.io or http://ec2-35-170-249-132.compute-1.amazonaws.com.
